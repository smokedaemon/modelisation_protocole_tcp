...
L1 = Link("L1", distance=1000, speed=2e8, lost_prob=0.1)
L2 = Link("L2", distance=1000, speed=2e8, lost_prob=0.02)

# Configuration identique au mode précédent mais avec retransmission [cite: 103]
hostA = Host(sim, 'A', mode=ReliabilityMode.ACKNOWLEDGES_WITH_RETRANSMISSION)
...
hostB = Host(sim, 'B', mode=ReliabilityMode.ACKNOWLEDGES_WITH_RETRANSMISSION)
