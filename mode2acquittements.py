...
L2 = Link("L2", distance=1000, speed=2e8, lost_prob=0.1)

# Configuration Mode ACKNOWLEDGES [cite: 43]
hostA = Host(sim, 'A', mode=ReliabilityMode.ACKNOWLEDGES)
...
hostB = Host(sim, 'B', mode=ReliabilityMode.ACKNOWLEDGES)
